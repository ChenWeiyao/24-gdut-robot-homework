function finger7_DH_mov(theta,d,a,alpha)
    %拇指的DH建模
    ToDeg = 180/pi;
    ToRad = pi/180;
    UX = [1 0 0]';
    ...
    Link_finger7(1)= struct('name','Base' , 'th', (theta+315)*ToRad, 'dz', d, 'dx',a, 'alf',alpha*ToRad,'az',UZ); %BASE to 1
    
    Link_finger7(2) = struct('name','J1' , 'th', 90*ToRad, 'dz', 100, 'dx',0, 'alf',180*ToRad,'az',UZ); %1 TO 2 
