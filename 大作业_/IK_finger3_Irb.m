function[th1_finger3,th2_finger3,th3_finger3,th4_finger3,th5_finger3] = IK_finger3_Irb(Tpos,rpos,th1,th2,th3,th4,th5,th6,th1_finger0,th2_finger0,th3_finger0,th4_finger0,th5_finger0,th1_finger1,th2_finger1,th3_finger1,th4_finger1,th5_finger1,th1_finger2,th2_finger2,th3_finger2,th4_finger2,th5_finger2,th1_finger3,th2_finger3,th3_finger3,th4_finger3,th5_finger3,th1_finger4,th2_finger4,th3_finger4,th4_finger4,th5_finger4,th1_finger5,th2_finger5,th3_finger5,th4_finger5,th5_finger5,th1_finger6,th2_finger6,th3_finger6,th4_finger6,th5_finger6,th1_finger7,th2_finger7,th3_finger7,th4_finger7,th5_finger7)
    ...
    while (1)
        ...
        %
        J=Jacobian5DoF_finger3(th1_finger3,th2_finger3,th3_finger3,th4_finger3,th5_finger3);    %
        learning_rate = min(Loss, 0.8); %
        %         learning_rate =0.2;
        dth = learning_rate * pinv(J) * [p_err; w_err];  %
        th1_finger3=th1_finger3+dth(1)*ToDeg;
        th1_finger3 = max(th1_min, min(th1_max, th1_finger3));
        th2_finger3=th2_finger3+dth(2)*ToDeg;
        th2_finger3 = max(th2_min, min(th2_max, th2_finger3));
        th3_finger3=th3_finger3+dth(3)*ToDeg;
        th3_finger3 = max(th3_min, min(th3_max, th3_finger3));
        th4_finger3=th4_finger3+dth(4)*ToDeg;
        th4_finger3 = max(th4_min, min(th4_max, th4_finger3));
        th5_finger3=th5_finger3+dth(5)*ToDeg;
        th5_finger3 = max(th5_min, min(th5_max, th5_finger3));
