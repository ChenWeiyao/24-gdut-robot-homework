function[th_finger0_1,th_finger0_2,th_finger0_3,th_finger0_4,th_finger0_5] = IK_finger0(Tpos,rpos)
    global Link_finger0
    num=1;
    ToDeg = 180/pi;
    ToRad = pi/180;
    ...
    while (1)
        ...
        %
        J=Jacobian5DoF_finger0(th_finger0_1,th_finger0_2,th_finger0_3,th_finger0_4,th_finger0_5);    %
