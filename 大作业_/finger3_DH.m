...
Link_finger3(1)= struct('name','Base' , 'th',135*ToRad, 'dz', 0, 'dx', 0, 'alf',0*ToRad,'az',UZ); %BASE to 1

Link_finger3(2) = struct('name','J1' , 'th', 90*ToRad, 'dz', 40, 'dx',0, 'alf',180*ToRad,'az',UZ); %1 TO 2 
