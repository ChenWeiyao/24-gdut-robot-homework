function DHfk_finger1_Lnya(th1_finger1,th2_finger1,th3_finger1,th4_finger1,th5_finger1,fcla)
...
for i=2:6
      ...
      hold on;
      plot3(Link_finger1(i).p(1),Link_finger1(i).p(2),Link_finger1(i).p(3),'rx');
      hold on;
      if i<=6
          DrawCylinder(Link_finger1(i-1).p, Link_finger1(i-1).R * Link_finger1(i).az, radius,len, joint_col); hold on;
      end 
end
% view(125,52);
