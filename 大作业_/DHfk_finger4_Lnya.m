function DHfk_finger4_Lnya(th1_finger4,th2_finger4,th3_finger4,th4_finger4,th5_finger4,fcla)
...
for i=2:6
      ...
      hold on;
      plot3(Link_finger4(i).p(1),Link_finger4(i).p(2),Link_finger4(i).p(3),'rx');
      hold on;
      if i<=6
          DrawCylinder(Link_finger4(i-1).p, Link_finger4(i-1).R * Link_finger4(i).az, radius,len, joint_col); hold on;
      end 
end
% view(125,52);
